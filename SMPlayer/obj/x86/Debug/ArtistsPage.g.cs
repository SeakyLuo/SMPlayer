#pragma checksum "C:\Users\Seaky\source\repos\SMPlayer\SMPlayer\ArtistsPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "562BC8C749284354780F0C29621D35C7"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace SMPlayer
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IArtistsPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 219 && columnNumber == 57)
                {
                    isobj25ForegroundDisabled = true;
                }
                else if (lineNumber == 220 && columnNumber == 57)
                {
                    isobj25TextDisabled = true;
                }
                else if (lineNumber == 209 && columnNumber == 61)
                {
                    isobj26VisibilityDisabled = true;
                }
                else if (lineNumber == 213 && columnNumber == 61)
                {
                    isobj27ForegroundDisabled = true;
                }
                else if (lineNumber == 214 && columnNumber == 61)
                {
            ...
            IArtistsPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 188 && columnNumber == 41)
                {
            ...
            IArtistsPage_Bindings
        {
            ...
            private void Update_(global::SMPlayer.Models.ArtistView obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_IsUnloaded(obj.IsUnloaded, phase);
                    }
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Name(obj.Name, phase);
            ...
            private void Update_IsUnloaded(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // ArtistsPage.xaml line 116
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_IsUnloaded(obj.IsUnloaded, DATA_CHANGED);
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 3: // ArtistsPage.xaml line 39
                ...
                break;
            case 4: // ArtistsPage.xaml line 44
                {
            ...
            case 6: // ArtistsPage.xaml line 52
                ...
                break;
            case 7: // ArtistsPage.xaml line 60
                {
                ...
                break;
            case 15: // ArtistsPage.xaml line 113
                {
            ...
            case 20: // ArtistsPage.xaml line 181
                ...
                break;
            case 23: // ArtistsPage.xaml line 194
                {
                ...
                break;
            case 30: // ArtistsPage.xaml line 177
                {
