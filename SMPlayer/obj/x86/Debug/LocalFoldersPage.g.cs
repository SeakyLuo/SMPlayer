#pragma checksum "C:\Users\Seaky\source\repos\SMPlayer\SMPlayer\LocalFoldersPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "02562C855000A1872A6620B1206BEFA2"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace SMPlayer
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ILocalFoldersPage_Bindings
        {
            ...
            {
                if (lineNumber == 331 && columnNumber == 33)
                {
                    isobj41TextDisabled = true;
                }
                else if (lineNumber == 338 && columnNumber == 33)
                {
                ...
                else if (lineNumber == 293 && columnNumber == 41)
                {
                    isobj44SourceDisabled = true;
                }
                else if (lineNumber == 297 && columnNumber == 41)
                {
                    isobj45SourceDisabled = true;
                }
                else if (lineNumber == 301 && columnNumber == 41)
                {
            ...
            private void Update_Name(global::System.String obj, int phase)
            {
                ...
                {
                    // LocalFoldersPage.xaml line 327
            ...
            private void Update_MusicCount(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 333
            ...
            private void Update_First(global::Windows.UI.Xaml.Media.Imaging.BitmapImage obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 286
            ...
            private void Update_Second(global::Windows.UI.Xaml.Media.Imaging.BitmapImage obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 290
            ...
            private void Update_Third(global::Windows.UI.Xaml.Media.Imaging.BitmapImage obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 294
            ...
            private void Update_Fourth(global::Windows.UI.Xaml.Media.Imaging.BitmapImage obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 298
            ...
            private void Update_LargeThumbnail(global::Windows.UI.Xaml.Media.Imaging.BitmapImage obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 302
            ...
            ILocalFoldersPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 257 && columnNumber == 13)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 35: // LocalFoldersPage.xaml line 250
            ...
            private void Update_GridItems(global::System.Collections.ObjectModel.ObservableCollection<global::SMPlayer.Models.GridFolderView> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // LocalFoldersPage.xaml line 250
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 29: // LocalFoldersPage.xaml line 32
                {
                ...
                break;
            case 31: // LocalFoldersPage.xaml line 17
                {
                ...
                break;
            case 32: // LocalFoldersPage.xaml line 23
                {
            ...
            case 35: // LocalFoldersPage.xaml line 250
                ...
                break;
            case 36: // LocalFoldersPage.xaml line 359
                {
            ...
            case 38: // LocalFoldersPage.xaml line 261
                ...
                break;
            case 39: // LocalFoldersPage.xaml line 264
                {
                ...
                break;
            case 49: // LocalFoldersPage.xaml line 314
                {
                ...
                break;
            case 50: // LocalFoldersPage.xaml line 319
                {
